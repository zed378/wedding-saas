...
**Current phase**: Phase 0 — Foundation (10 / 26 done). The API runs, validates its configuration and serves the three surfaces, and the local stack comes up with one command. `P0-08` (templates, versions, media) is next on the critical path; `P0-12`, `P0-13`, `P0-18`, `P0-19` and `P0-22` are all unblocked and can run in parallel.
**Overall**: 10 / 135 tasks done
...
|---|---|---|---|---|
| [Phase 0 — Foundation](./PHASE-0-FOUNDATION.md) | 26 | 10 | **ACTIVE** | — |
