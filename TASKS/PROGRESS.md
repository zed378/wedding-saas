...
| [Phase 2 — Template Rendering and Preview](./PHASE-2-TEMPLATE-RENDERING-AND-PREVIEW.md) | 17 | 16 | **REOPENED** — two owner-requested cards after closure | Phase 1 exit + `P1-25` — **met** |
| [Phase 3 — Order, Payment and Publishing](./PHASE-3-ORDER-PAYMENT-PUBLISHING.md) | 16 | 0 | Next, after `P2-17` | Phase 2 exit — **met** (LCP qualified by `OQ-26`) |
...
| P2-17 | Indonesian administrative regions (province to village) | backend, web-app | L | TODO — requested by the owner 2026-09-13; spec required | P2-16 |
