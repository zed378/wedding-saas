...
## Base URL & Versioning
- `https://api.maindomain.com/api/v1/...` for the authenticated/internal API.
- `https://api.maindomain.com/public/...` for the public API (no auth: get a public invitation, submit RSVP/guestbook).
